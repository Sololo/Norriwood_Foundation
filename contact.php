...
if(isset($_POST['send'])){
   ...
   $insert = "INSERT INTO `contact_form`(`name`, `email`, `number`, `field`, `address`, `message`) VALUES ('$name','$email','$number','$field','$address','$message')";
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            ...
            <select name="plan">
               ...
               <option value="vocal artist">vocal artist</option>
            </select>
         </div>
